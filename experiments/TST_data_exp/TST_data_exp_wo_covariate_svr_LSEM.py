...
def main():
    ...
    params_df.to_csv(os.path.join(result_path,'tst_exp_wo_covariate_svr_LSEM.csv'))
    
    res = pd.read_csv('./results/csv_files/tst_exp_wo_covariate_svr_LSEM.csv')
    ...
    with open('./results/tst_exp_wo_covariate_svr_LSEM.pkl', 'wb') as fp:
        pkl.dump(res, fp)
