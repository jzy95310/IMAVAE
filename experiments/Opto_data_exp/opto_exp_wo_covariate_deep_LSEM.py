...
def main():
    ...
    params_df.to_csv(os.path.join(result_path,'opto_exp_wo_covariate_deep_LSEM.csv'))
    
    res = pd.read_csv('./results/csv_files/opto_exp_wo_covariate_deep_LSEM.csv')
    ...
    with open('./results/opto_exp_wo_covariate_deep_LSEM.pkl', 'wb') as fp:
        pkl.dump(res, fp)
