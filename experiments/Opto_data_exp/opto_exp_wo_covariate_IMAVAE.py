...
def main(args):
    ...
    if not os.path.exists('./results/'):
        os.makedirs('./results/')
    with open('./results/opto_exp_wo_covariate_IMAVAE.pkl', 'wb') as fp:
        pkl.dump(res, fp)
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--recon_weight', type=float, default=1.)
    arg_parser.add_argument('--elbo_weight', type=float, default=1.)
    ...
    arg_parser.add_argument('--batch_size', type=int, default=24540)
